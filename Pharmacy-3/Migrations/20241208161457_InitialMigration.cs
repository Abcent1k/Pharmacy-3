        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Consumables_ExpirationDate = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValue: new DateTime(2029, 12, 8, 18, 14, 56, 984, DateTimeKind.Local).AddTicks(6728)),
                    ConsumableType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeviceType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExpirationDate = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValue: new DateTime(2025, 12, 8, 18, 14, 56, 988, DateTimeKind.Local).AddTicks(6874)),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InventoryProducts_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryProducts_OrderId",
